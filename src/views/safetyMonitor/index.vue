    ...
    <el-row :gutter="10">
      <el-col :span="8">
        <el-card class="box-card">
          ...
          <div class="list">
            <div class="list-data"><div class="left bg-green-l">昨日</div><div class="right bg-green-r">123456 kw·h</div></div>
            <div class="list-data"><div class="left bg-blur-l">当月</div><div class="right bg-blur-r">123456 kw·h</div></div>
            <div class="list-data"><div class="left bg-blur-l">当月</div><div class="right bg-blur-r">123456 kw·h</div></div>
             <div class="list-data"><div class="left bg-yellow-l">昨日</div><div class="right bg-yellow-r">123456 kw·h</div></div>
            <div class="list-data"><div class="left bg-yellow-l">当月</div><div class="right bg-yellow-r">123456 kw·h</div></div>
          </div>
        </el-card>
      </el-col>
      <el-col :span="8">
